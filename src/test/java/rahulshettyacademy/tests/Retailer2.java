...
public class Retailer2 {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		if (ordertype.getText().equals("DELIVERY") ){
		Thread.sleep(2000);
		WebElement dispatch= driver.findElement(By.xpath("(//ion-button[text()='Dispatch'])[2]"));
		Actions act1=new Actions(driver);
		act1.click(dispatch).perform();
        driver.switchTo().activeElement();
        WebElement dispatchbtn=driver.findElement(By.xpath("//span[text()='Dispatch']"));
        act1.click(dispatchbtn).perform();
        driver.switchTo().activeElement();
        driver.findElement(By.xpath("//p[text()='Me']")).click();
		...
		driver.findElement(By.xpath("//ion-button[text()='Start Delivery']")).click();
		driver.switchTo().activeElement();
	    driver.findElement(By.xpath("//ion-button[text()='Yes']")).click();
	    driver.findElement(By.xpath("//ion-button[text()='Reached Delivery Location']")).click();
		driver.switchTo().activeElement();
	    driver.findElement(By.xpath("//ion-button[text()='Yes']")).click();
	    driver.findElement(By.xpath("//ion-button[text()='Delivered ']")).click();
		driver.switchTo().activeElement();
	    driver.findElement(By.xpath("//ion-button[text()='Yes']")).click();
